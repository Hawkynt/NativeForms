...
public class ColorPicker : OwnerDrawnControl {
  ...
  private void UpdateTriangle(Mixer mixer, MouseEventArgs e) {
    ...
    if (w1 < 0) { w1 = 0; var t = w2 + w3; if (t > 0) { w2 /= t; w3 /= t; } else { w2 = w3 = 0.5; } } else if (w2 < 0) { w2 = 0; var t = w1 + w3; if (t > 0) { w1 /= t; w3 /= t; } else { w1 = w3 = 0.5; } } else if (w3 < 0) { w3 = 0; var t = w1 + w2; if (t > 0) { w1 /= t; w2 /= t; } else { w1 = w2 = 0.5; } }
