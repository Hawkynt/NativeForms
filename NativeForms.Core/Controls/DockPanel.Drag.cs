...
public partial class DockPanel {
  ...
  private void ComputeDropTarget(Point pt) {
    ...
    DockGuide guide;
    Rectangle preview;
    if (pt.X < b.X + bandX && pt.X - b.X <= b.Bottom - pt.Y && pt.X - b.X <= pt.Y - b.Y) { guide = DockGuide.Left; preview = new Rectangle(b.X, b.Y, b.Width / 2, b.Height); } else if (pt.X > b.Right - bandX && b.Right - pt.X <= b.Bottom - pt.Y && b.Right - pt.X <= pt.Y - b.Y) { guide = DockGuide.Right; preview = new Rectangle(b.X + b.Width / 2, b.Y, b.Width - b.Width / 2, b.Height); } else if (pt.Y < b.Y + bandY) { guide = DockGuide.Top; preview = new Rectangle(b.X, b.Y, b.Width, b.Height / 2); } else if (pt.Y > b.Bottom - bandY) { guide = DockGuide.Bottom; preview = new Rectangle(b.X, b.Y + b.Height / 2, b.Width, b.Height - b.Height / 2); } else { guide = DockGuide.Center; preview = b; }
